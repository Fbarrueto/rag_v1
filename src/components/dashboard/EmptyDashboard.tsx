...
const EmptyDashboard = () => {
  ...
  return <div className="text-center py-16">
      <div className="mb-12">
        <h2 className="text-3xl font-medium text-gray-900 mb-4">Crea tu primer Notebook !</h2>
        <p className="text-lg text-gray-600 max-w-2xl mx-auto">Rag Viva es un asistente de investigación y escritura impulsado por IA que funciona mejor con las fuentes que subes.</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto mb-12">
        ...
        <div className="bg-white rounded-lg border border-gray-200 p-6 text-center">
          ...
          <p className="text-gray-600">Añade páginas web y artículos en línea como fuentes</p>
        </div>
      ...
      <Button onClick={handleCreateNotebook} size="lg" className="bg-blue-600 hover:bg-blue-700" disabled={isCreating}>
        ...
        {isCreating ? 'Creating...' : 'Crea un notebook'}
      </Button>
    </div>;
};

      ...
      <Dialog open={open} onOpenChange={onOpenChange}>
        <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
          <DialogHeader className="pb-4">
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-2">
                ...
                <DialogTitle className="text-xl font-medium">Rag Viva</DialogTitle>
              </div>
            </div>
          </DialogHeader>
          ...
          <div className="space-y-6">
            <div>
              <h2 className="text-xl font-medium mb-2">Añade Fuentes</h2>
              <p className="text-gray-600 text-sm mb-1">Las fuentes permiten que Rag Viva base sus respuestas en la información que más te importa..</p>
              <p className="text-gray-500 text-xs">
                (Ejemplos: planes de marketing, lecturas de cursos, notas de investigación, transcripciones de reuniones, documentos de ventas, etc.)
              </p>
            </div>
